...
class Level3Scene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        //setupExplosion001() // Create explosions.
        //setupExplosionSound() // Create explosion sound.
    ...
    func levelOver(playerWin: Bool){
        ...
        let runAction = SKAction.runBlock { () -> Void in
            ...
            let scene = MidGameHubScene(_size: CGSize(width: self.frame.width, height: self.frame.height), _score: self.baseLevel.score, isWin: playerWin, _levelName: 3)
